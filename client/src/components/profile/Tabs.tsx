    ...
    <div className="mb-10">
      <div className="sm:hidden">
        ...
        <select
          id="tabs"
          name="tabs"
          className="block w-full rounded-lg border border-gray-300 bg-white py-2 px-3 text-sm text-gray-700 shadow-sm focus:border-purple-800 focus:outline-none focus:ring-1 focus:ring-purple-800"
